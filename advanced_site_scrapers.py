...
class AdvancedSiteScrapers:
    """
    Gelişmiş site spesifik scraping sistemi
    Her site için özel işlemler ve fallback mekanizmaları
    """
    ...
    def __init__(self):
        self.site_configs = {
            "beymen.com": {
                ...
                "special_handlers": [self._handle_beymen_special],
                "wait_time": 2000,
                "timeout": 30000
            },
            ...
            "ellesse.com.tr": {
                ...
                "special_handlers": [self._handle_ellesse_special],
                "wait_time": 2000,
                "timeout": 30000
            },
            ...
            "beyyoglu.com": {
                ...
                "special_handlers": [self._handle_beyyoglu_special],
                "wait_time": 3000,
                "timeout": 30000
            },
            ...
            "ninewest.com.tr": {
                ...
                "special_handlers": [self._handle_ninewest_special],
                "wait_time": 2000,
                "timeout": 30000
            },
            ...
            "levis.com.tr": {
                ...
                "special_handlers": [self._handle_levis_special],
                "wait_time": 2000,
                "timeout": 30000
            },
            ...
            "dockers.com.tr": {
                ...
                "special_handlers": [self._handle_dockers_special],
                "wait_time": 2000,
                "timeout": 30000
            },
            ...
            "sarar.com": {
                ...
                "special_handlers": [self._handle_sarar_special],
                "wait_time": 2000,
                "timeout": 30000
            },
            ...
            "salomon.com.tr": {
                ...
                "special_handlers": [self._handle_salomon_special],
                "wait_time": 2000,
                "timeout": 30000
            },
            ...
            "abercrombie.com": {
                ...
                "special_handlers": [self._handle_abercrombie_special],
                "wait_time": 2000,
                "timeout": 30000
            },
            ...
            "loft.com.tr": {
                ...
                "special_handlers": [self._handle_loft_special],
                "wait_time": 2000,
                "timeout": 30000
            },
            ...
            "ucla.com.tr": {
                ...
                "special_handlers": [self._handle_ucla_special],
                "wait_time": 2000,
                "timeout": 30000
            },
            ...
            "yargici.com": {
                ...
                "special_handlers": [self._handle_yargici_special],
                "wait_time": 2000,
                "timeout": 30000
            }
        }
        ...
        for selector in selectors:
            try:
                if ":contains(" in selector:
                    # Özel contains selector'ı için
                    text_content = selector.split(":contains(")[1].split(")")[0]
                    elements = await page.query_selector_all(selector.split(":contains(")[0])
                    for element in elements:
                        text = await element.text_content()
                        if text and text_content in text:
                            return text.strip()
                else:
    ...
    # Özel işleyiciler
    async def _handle_beymen_special(self, page):
        """Beymen için özel işlemler"""
        try:
    ...
    async def _handle_ellesse_special(self, page):
        """Ellesse için özel işlemler"""
        try:
            # Sayfa yüklenmesini bekle
            await page.wait_for_selector("h1.product__title", timeout=10000)
        except:
            pass
    
    async def _handle_beyyoglu_special(self, page):
        """Beyyoglu için özel işlemler"""
        try:
            # pz-price elementlerinin yüklenmesini bekle
            await page.wait_for_selector("pz-price", timeout=10000)
        except:
            pass
    
    async def _handle_ninewest_special(self, page):
        """Nine West için özel işlemler"""
        try:
            # Sayfa yüklenmesini bekle
            await page.wait_for_selector("h1.product-name", timeout=10000)
        except:
            pass
    
    async def _handle_levis_special(self, page):
        """Levi's için özel işlemler"""
        try:
            # Sayfa yüklenmesini bekle
    ...
    async def _handle_dockers_special(self, page):
        """Dockers için özel işlemler"""
        try:
            # Sayfa yüklenmesini bekle
            await page.wait_for_selector("div.product-title", timeout=10000)
        except:
            pass
    
    async def _handle_sarar_special(self, page):
        """Sarar için özel işlemler"""
        try:
            # Sayfa yüklenmesini bekle
            await page.wait_for_selector("h1#product-title", timeout=10000)
        except:
    ...
    async def _handle_salomon_special(self, page):
        """Salomon için özel işlemler"""
        try:
            # Sayfa yüklenmesini bekle
            await page.wait_for_selector("span.spanFiyat", timeout=10000)
        except:
            pass
    
    async def _handle_abercrombie_special(self, page):
        """Abercrombie için özel işlemler"""
        try:
            # Sayfa yüklenmesini bekle
            await page.wait_for_selector("h1.product-title-component", timeout=10000)
        except:
            pass
    
    async def _handle_loft_special(self, page):
        """Loft için özel işlemler"""
        try:
            # Sayfa yüklenmesini bekle
            await page.wait_for_selector("h1.product-detail-product-name", timeout=10000)
        except:
            pass
    
    async def _handle_ucla_special(self, page):
        """UCLA için özel işlemler"""
        try:
            # Sayfa yüklenmesini bekle
            await page.wait_for_selector("h1.product-name", timeout=10000)
        except:
    ...
    async def _handle_yargici_special(self, page):
        """Yargıcı için özel işlemler"""
        try:
            # Sayfa yüklenmesini bekle
            await page.wait_for_selector("h1.MuiTypography-root", timeout=10000)
        except:
            pass
...
async def test_advanced_scrapers():
    ...
    print(f"\nTüm sonuçlar advanced_scraping_results.json dosyasına kaydedildi.")

if __name__ == "__main__":
    asyncio.run(test_advanced_scrapers())
